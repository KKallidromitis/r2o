...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(type='RandomCrop', crop_size=(769, 769), cat_max_ratio=0.99),
            dict(type='RandomFlip', prob=0.5),
            dict(
                type='Normalize',
                mean=[123.675, 116.28, 103.53],
...
model = dict(
    type='EncoderDecoder',
    pretrained='./05-18-01-49-300.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
checkpoint_config = dict(by_epoch=True, interval=80)
learning_rate = 0.04
...
work_dir = './work_dirs_cityscapes/r2o-cityscapes'
gpu_ids = range(0, 4)
auto_resume = False
